...
$('.appt_tabs_dropdown li').click(function () {
    $('.appt_tabs_dropdown li').removeClass('active');
})
$(function () {
...
$(function () {
    $('.dtimepicker').datetimepicker({format: 'YYYY/MM/DD hh:mm A'});
...
var Main = function () {
    ...
    var setSearchMenu = function () {
        ...
        //   $('.menu-search ul li a').on('click', function(e) {
        //      $url = $(this).attr('href');
        //      alert($url);
        //      e.preventDefault();
        // });
    ...
    var runToggleSideBars = function () {
        ...
        $(".top_menu_toggle").on("click", function (e) {
            $body.toggleClass('left-sidebar-hide');
            if ($body.hasClass("left-sidebar-hide")) {
                $('#pageslide-left').animate({
                    width: '0%'
                });
