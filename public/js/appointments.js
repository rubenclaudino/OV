         ...
         success: function(data){
            if(data != 'error'){
               ...
               for($i=0;$i< data.length;$i++){
                  ...
                  $html += "<li data-json='"+data+"' data-id='"+data[$i].id+"' data-telephone='"+data[$i].telephone+"'  data-mobile='"+data[$i].mobile+"' data-observation='"+data[$i].patient_observation+"' data-name='"+data[$i].first_name+" "+data[$i].last_name+"' >"+data[$i].first_name+" "+data[$i].last_name+" <small>("+$phone+")</small></li>";
               }
               $html += "</ul>";
            }
         }
