var Calendar = function() {
    ...
    var runFullCalendar = function() {
        ...
        $('#full-calendar').fullCalendar({
            ...
            buttonIcons: {
                prev: 'fa fa-arrow-circle-o-left',
    ...
    var readFullEvents = function(el) {
        ...
        $("#readFullEvent").find(".delete-event").off().on("click", function() {
            ...
            bootbox.confirm("Certeza que deseja cancelar?", function(result) {
                if (result) {
                    $.blockUI({
    ...
    var runFullCalendarValidation = function(el) {
        ...
        formEvent.validate({
            ...
            submitHandler: function(form) {
				...
				newEvent.backgroundColor='red!important',
				newEvent.textColor='#fff!important',
	...
	/* var showAppointmentDetails = function(el) {
