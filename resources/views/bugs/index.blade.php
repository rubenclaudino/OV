            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 panel" style="background: white;margin-top: 15px">
                ...
                @foreach($bugs as $bug)
                    ...
                    <div style="margin-bottom: 15px;padding: 5px">
                        ...
                        <h5 style="padding: 5px;opacity: 0.8">{{ $bug->created_at->format('d/m/Y H:i') }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small class="label label-info pull-right" style="color: white;opacity: 0.8">Postado á {{ $bug->created_at->diffForHumans() }}</small></h5>
                    ...
                    <div class="panel" style="border-radius: 0px;padding: 10px;opacity: 0.95;background: whitesmoke;padding-left: 25px;border-left: 4px lightskyblue solid">
                        ...
                        <table>
                            <tr>
                                ...
                                <td> <h5 style="color: #3d3d3d;font-size: 1.1em">{{ $bug->status }} </h5></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td> <h5 style="color: #3d3d3d;font-size: 1.1em">{{ $bug->report }} </h5></td>
                            </tr>
                            <tr>
