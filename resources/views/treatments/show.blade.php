            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 15px;margin-bottom: 15px">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 panel panel-white"
                         style="padding-bottom: 5px;padding-left: 20px;padding-top:0px;font-size: 1.1em ">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 ">
                                <div class="btn-group pull-right" style="margin-top:20px;">
                                    <button class="btn dropdown-toggle btn-squared" data-toggle="dropdown"
                                            aria-expanded="false" style="border-radius: 1px;background: #dddddd">
                                        Opções &nbsp; <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li><a href="{{ URL::route('patients.edit', $plan->id) }}"><i
                                                        class="fa fa-pencil fa-fw text-info" style="color: #404040"></i>&nbsp;&nbsp;Editar</a>
                                        </li>
                  ...
                  <span class="pull-right">
                     ...
                     <button type="button" class="btn btn-info btn-md btn-block panel-azure"
                             style="padding: 8px;border-radius: 2px;border: transparent;margin-bottom: 7px">
