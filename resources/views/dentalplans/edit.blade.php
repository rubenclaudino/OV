                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control" id="title" name="title"  type="text" value="{{ $plan->title }}">
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control" id="url" name="url" type="text" value="{{ $plan->url }}">
                                       </div>
                                    </div>
                                     <!-- end: SITE -->
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control" id="address" name="address" type="text" value="{{ $plan->address }}">
                                       </div>
                                    </div>
                                     <!-- end: ROAD -->
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control" id="number" name="number" type="text" value="{{ $plan->number }}">
                                       </div>
                                    </div>
                                     <!-- end: NUMBER -->
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                          <label for="borough">Borough</label>
                                           <input class="form-control" id="borough" name="borough" type="text" value="{{ $plan->borough }}">
                                       </div>
                                    </div>
                                     <!-- end: BOUROUGH -->
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control" id="cep" name="cep" type="text" value="{{ $plan->cep }}">
                                       </div>
                                    </div>
                                     <!-- end: CEP -->
                                     ...
                                     <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                         <div class="form-group">
                                             ...
                                             <input class="form-control" id="city" name="city" type="text" value="{{ $plan->city }}">
                                         </div>
                                     </div>
                                     <!-- end: CITY -->
                                    ...
                                    <hr>
                                       <div class="form-group">
                                           <button class="btn btn-danger">
                                               <a href="{{ url('/dentalplans')}}" style="color: white">
                                                    Cancelar
                                               </a>
                                           </button>
