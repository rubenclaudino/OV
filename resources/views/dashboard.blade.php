                    ...
                    <form class="form-full-event">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <input class="event-id hide" type="text">
      									<span class="input-icon input-icon-right">
      										<input name="eventName" type="text" placeholder="Patient Name..."
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker" name="treatment_type_id">
                                            ...
                                            <option data-content="<span class='event-category event-cancelled'><?php //echo $data['treatment_type_title'];?></span>"
                                                    value="<?php //echo $data['treatment_type_id'];?>"><?php //echo $data['treatment_type_title'];?></option>
                                            <?php //}
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker" name="appointment_status">
                                            <option data-content="<span class='event-category event-booked'>Booked</span>"
                                                    value="1">Booked
                                            </option>
                                            <option data-content="<span class='event-category event-cancelled'>Cancelled</span>"
                                                    value="2">Cancelled
                                            </option>
                                            <option data-content="<span class='event-category event-missed'>Missed</span>"
                                                    value="3">Missed
                                            </option>
                                            <option data-content="<span class='event-category event-completed'>Finished</span>"
                                                    value="4" selected="selected">Finished
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <select class="form-control selectpicker" name="dental_plan_id">
                                            <option value="1"
                                                    data-content="<span class='event-category event-cancelled'>Private</span>"
                                                    value="event-private">Private
                                            </option>
                                            <option value="2"
                                                    data-content="<span class='event-category event-home'>Dental Insurance</span>"
                                                    value="event-dental_insurance">Dental Insurance
                                            </option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input name="app_obs" type="text" placeholder="Observation..."
                                               class=" form-control">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="panel panel-white accepted_plan "
                                 style="margin-top:15px;margin-bottom:15px!important;">
                                <div class="panel-body">
                                    <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 nopadding">
                                    <button class="btn btn-success btn-block save-new-event" type="submit"
                                            style="width:100%;">
                                        Save
                                    </button>
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="fileupload fileupload-new contributor-avatar" data-provides="fileupload">
                                <div class="fileupload-new thumbnail"><img src="images/anonymous.jpg" alt="" width="50"
                                                                           height="50"/>
                                </div>
