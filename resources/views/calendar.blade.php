...
<div class="main-container inner">
            ...
            <div class="modal-content">
                ...
                <form id="addQuickPatient" method="post">
                    ...
                    <div class="modal-header" style="background:#F1F1F1;">
                        <h2 style="font-weight: 100">Paciente <br>
                            <small style="color:silver"> Cadastro basico para paciente novo</small>
                        </h2>
                    </div>
                    <!-- end: MODAL HEADER -->
                    ...
                    <div class="modal-body" style="padding: 15px">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <input class="form-control" id="" name="celular_1" required type="text"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-grey" data-dismiss="modal">
                            Fechar
                        </button>
    ...
    <!-- CURRENT DATE EVENT MODAL -->
    <div aria-hidden="true" id="todaysEvent" class="modal extended-modal fade no-display" style="background: #dddddd"
         tabindex="-1" data-width="450">
        <div class="modal-sm modal-dialog ">
            <div class="modal-content">
                <div class="modal-header" style="background:#ededed;">
                    <h3 id="myLargeModalLabel" class="modal-title">Agendamentos Hoje</h3>
                </div>
                <div class="modal-body">
                </div>
            </div>
            ...
            <div class="patient_details">
                ...
                <div class="patient_speciality">
                    <span class="label label-default" ng-repeat="speciality in patient.speciality"
                          style="background: #{[{ speciality.color_code }]} !important;opacity: 0.7;letter-spacing: 1px !important;margin-right: 5px;">{[{ speciality.title }]}</span>
                    <br>
                </div>
                <!-- end: SPECIALTY -->
                ...
                <h5 style="padding-bottom: 5px">
                    <i class="fa fa-map-marker fa-fw"></i>&nbsp; {[{ patient.address.street_address }]}
                </h5>
                <!-- end: ADDRESS -->

                <!-- start: PHONE -->
                <h5>
                    <i class="fa fa-phone fa-fw"></i>&nbsp; {[{ patient.contact.phone_landline }]} &nbsp;&nbsp;
                    <i class="fa fa-mobile fa-fw"></i>&nbsp; {[{ patient.contact.celular_1 }]}
                </h5>
                <!-- end: PHONE -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectpicker appointment_type_status"
                                                        name="status">
