        ...
        <div class="container" style="margin-top: -25px">
            ...
            <div class="panel panel-white" style="margin-top: 50px">
                ...
                <div class="panel-heading" style="padding: 5px 25px">
                    <h1 style="font-weight: lighter">{{ $title }} <br>
                        <small style="font-weight: lighter;color: #d1c4e9">{{ $subtitle }}</small>
                    </h1>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            {{ Form::text('email',$user->email,array('placeholder' => 'This will be also your login','class' => 'form-control','disabled' => 'true')) }}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('dob') ? 'has-error' : '' }}">
                            ...
                            {{ Form::text('dob',$user->date_of_birth,array('placeholder' => 'Date of Birth','class' => 'form-control datepicker')) }}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('cpf') ? 'has-error' : '' }}">
                            <label for="fname">CPF</label>
                            {{ Form::text('cpf',$user->cpf,array('placeholder' => 'CPF','class' => 'form-control')) }}
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('rg') ? 'has-error' : '' }}">
                            ...
                            {{ Form::text('rg',$user->rg,array('placeholder' => 'RG','class' => 'form-control')) }}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('observation') ? 'has-error' : '' }}">
                            <label for="fname">Observações</label>
                            {{ Form::text('observation',$user->observation,array('placeholder' => 'Observation','class' => 'form-control')) }}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('cro') ? 'has-error' : '' }}">
                            <label for="fname">CRO</label>
                            {{ Form::text('cro',$user->cro,array('placeholder' => 'CRO','class' => 'form-control')) }}
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group {{ $errors->has('honors') ? 'has-error' : '' }}">
                            <label for="fname">Honors</label>
                            {{ Form::text('honors',$user->honors,array('placeholder' => 'Honors','class' => 'form-control')) }}
                        </div>
                    </div>
