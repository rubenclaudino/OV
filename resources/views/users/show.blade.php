                                    ...
                                    <div class="panel panel-white">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                                            ...
                                            <h5>
                                                ...
                                                &nbsp;{{ $user->phone_landline }}&nbsp;&nbsp; @else  @endif

                                                @if($user->phone_1 != null)<i class="fa fa-mobile fa-fw"></i>
                                                &nbsp;&nbsp;&nbsp;{{ $user->phone_1 }}&nbsp;&nbsp; @endif

                                                @if($user->whatsapp_number != '')<i
                                                        class="fa fa-mobile fa-fw"></i>&nbsp;&nbsp;
                                                &nbsp;{{ $user->whatsapp_number }}&nbsp;&nbsp; @endif
                                            </h5>
                     ...
                     <div class="col-lg-12 col-md-12">
                        <div class="panel panel-white" style="padding:10px; margin-top: 5px; background: whitesmoke">
                              <i class="fa fa-calendar-o fa-fw"></i>
                               &nbsp;&nbsp;Agendamentos
                              <span class="pull-right"
                                    style="padding-right: 10px"><strong>{{ count($user->appointments)}}</strong></span>
                        </div>
                     </div>
                         <!-- end: BOOKINGS -->
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-white" style="padding:10px; margin-top: 5px; background: whitesmoke">
                              <i class="fa fa-users fa-fw"></i>
                               &nbsp;&nbsp;Pacientes
                              <span class="pull-right"
                                    style="padding-right: 10px"><strong>{{ count($user->patients)}}</strong></span>
                        </div>
                     </div>
                    ...
                    <div class="tab-content panel" style="border-radius: 1px">
                                            ...
                                            <div class="panel-body" style="">
                                                ...
                                                <table class="table table-condensed ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:1.1em">@if( $user->borough ) {{ $user->borough }} @else
                                                                - @endif</td>
                                                        <td style="font-weight:bold;font-size:1.1em;width: 15%">CEP</td>
                                                        <td style="font-size:1.1em">@if( $user->zip_code ) {{ $user->zip_code }} @else
                                                                - @endif</td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div class="panel-body" style="">
                                                ...
                                                <table class="table table-condensed ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="font-size:1.1em;width: 15%">@if( $user->ref1 ) {{ $user->ref1 }} @else
                                                                - @endif</td>
                                                        <td class="hidden-xs"
                                                            style="font-weight:bold;font-size:1.1em;width: 25%">Telefone
                                                        </td>
                                                        <td class="hidden-xs"
                                                            style="font-size:1.1em;width: 15%">@if( $user->ref_num1 ) {{ $user->ref_num1 }} @else
                                                                - @endif</td>
                                                    </tr>
                                                    <tr>
                                                        <td style="font-weight:bold;font-size:1.1em;width: 25%">Contato
                                                        ...
                                                        <td style="font-size:1.1em;width: 15%">@if( $user->ref2 ) {{ $user->ref2 }} @else
                                                                - @endif</td>
                                                        <td style="font-weight:bold;font-size:1.1em;width: 25%">
                                                            Telefone
                                                        </td>
                                                        <td class="hidden-xs"
                                                            style="font-size:1.1em;width: 15%">@if( $user->ref_num2 ) {{ $user->ref_num2 }} @else
                                                                - @endif</td>
                                                    </tr>
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                    ...
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:1.1em">@if($user->resident_in_clinic == 1)
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-size:1.1em">R$ {{ $user->rent_neg }}</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;font-size:1.1em">
                                                Comissão negociada
                                            </td>
                                            <td style="font-size:1.1em">{{ $user->earn_percentage }} %</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;font-size:1.1em">
                                                Média Salarial
                        ...
                        <div id="health" class="tab-pane fade">
                            <div class="row" style="background:#fff;padding: 18px">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <table class="table table-striped" style="font-size:1.1em;">
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($user->take_drugs == 1) Sim @else Não @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Anomalias congénitas
                                            </td>
                                            <td>@if($user->has_birth_defect == 1) Sim @else Não @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Estágio de desenvolvimento ósseo
                                            </td>
                                            <td>@if($user->bone_dev_stage == 1) - @else - @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Utiliza algum anticoncepcional
                                            </td>
                                            <td>@if($user->take_preg_pills == 1) Sim @else Não @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Teve alguma operação grave
                                            </td>
                                            <td>@if($user->has_prev_surgeries == 1) Sim @else Não @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Estado de Saúde
                                            </td>
                                            <td>@if($user->current_health == 1) - @else - @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Biotipo
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($user->height){{ $user->height }} Cm @else - @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Peso
                                            </td>
                                            <td>@if($user->weight){{ $user->weight }} Kg @else - @endif</td>
                                        </tr>
                                        <tr>
                                            <td style="color: #383838;font-weight:bold;line-height:30px;">
                                                Cadeirante
                                            </td>
                                            <td>@if($user->wheel_chair == 1) Sim @else Não @endif</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    @if(!empty($user->diseases))
                                        @foreach($user->diseases as $da)
