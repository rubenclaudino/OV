   ...
   <div class="container">
      ...
      <div class="panel panel-white" style="margin-top:8px;">
         ...
         <div class="panel-body">
            <form id="addHoliday" method="POST" action="{{ url('/holidays') }}" autocomplete="off" enctype="multipart/form-data">
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
   					<div class="form-group">
   					  ...
   					  <input class="form-control" id="start_time" name="startimestamp" type="text" placeholder="Start Date">
   					</div>
   				</div>
