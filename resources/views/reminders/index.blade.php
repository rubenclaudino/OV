    ...
    <div class="row" style="margin-top:10px;margin-right: -3px">
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="toolbar-tools pull-right">
                        ...
                        <ul class="nav navbar-right">
                            <li>
                                <a href="#" data-toggle="modal" data-target="#addReminderModal"
                                   class="new-event MyToolbar">
        ...
        <div class="col-md-12 reminders" style="background: white;">
                        ...
                        <div class="list-group-item panel">
                            <div style="background: #dddddd;margin: 0px;padding: 15px 15px 1px 15px">
                                <h4 class="list-group-item-heading text-uppercase"
                                    style="color: #404040">{{ $data->reminder->title }}
                                    <span style="float: right">
                           <button class="btn btn-xs btn-success markDoneReminderUser"
                                   style="padding-right: 10px;opacity: 0.8" data-id="{{ $data->id }}"><i
                                       class="fa fa-check fa-fw"></i>&nbsp;Marcar Feito</button>
                           </span>
                                </h4>
                            </div>
                            <h5 style="color: #4d4d4d;padding: 15px">
                                <i class="fa fa-calendar fa-fw" style="margin: 5px;color: black;opacity: 0.45"></i>
                                <strong>{{ date('M, d Y h:i A', strtotime($data->reminder->reminder_date)) }}</strong>

                                <i class="fa fa-calendar fa-fw" style="margin: 5px;color: black;opacity: 0.45"></i>
                                Created:
                                <strong>{{ date('M, d Y h:i A', strtotime($data->reminder->created_at)) }}</strong>
            ...
            <!-- start: NO REMINDERS RECEIVED PANEL -->
                <div class="panel"
                     style="@if(isset($myReminders[0])) display:none; @endif;opacity: 0.5;border-radius: 1px;background-color: #07ACC2">
                    <span style="display: inline"><p style="padding: 15px;font-size: large;color: white"><i
                                    class="fa fa-info-circle fa-lg" style="color: white!important;"></i>&nbsp;&nbsp;Não existem lembretes recebidos no momento</p></span>
                </div>
            ...
            <div class="list-group remindersGroup">
                    ...
                    @foreach($reminders as $data)
                        <div class="list-group-item panel" style="border-radius: 1px;">
                          ...
                          <!-- <button class="btn btn-xs btn-success markDoneReminder" style="padding-right: 10px;opacity: 0.8" data-id="{{ $data->id }}"><i class="fa fa-check fa-fw"></i>&nbsp;Marcar Feito</button> -->
                              <button class="btn btn-xs btn-danger deleteReminder"
                                      style="padding-right: 10px;opacity: 0.8" data-id="{{ $data->id }}"><i
                                          class="fa fa-trash fa-fw"></i>&nbsp;Excluir</button>
                        </span>
                                </h4>
                            </div>
                            <h5 style="color: #4d4d4d;padding: 15px">
                                <i class="fa fa-calendar fa-fw" style="margin: 5px;color: black;opacity: 0.45"></i>
                                <strong>{{ date('M, d Y h:i A', strtotime($data->reminder_date)) }}</strong>
                                <i class="fa fa-calendar fa-fw" style="margin: 5px;color: black;opacity: 0.45"></i>
                                Created: <strong>{{ date('M, d Y h:i A', strtotime($data->created_at)) }}</strong>
                                <i class="fa fa-user fa-fw" style="margin: 5px;color: black;opacity: 0.45"></i>
                ...
                <!-- start: NO REMINDERS SENT PANEL -->
                    <div class="panel"
                         style="@if(isset($reminders[0])) display:none; @endif;opacity: 0.5;border-radius: 1px;background-color: #07ACC2">
                        <span style="display: inline"><p style="padding: 15px;font-size: large;color: white"><i
                                        class="fa fa-info-circle fa-lg" style="color: white!important;"></i>&nbsp;&nbsp;Não existem lembretes enviados no momento</p></span>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="reminder_date" placeholder="Data do Lembrete Aparecer"
                                   class="form-control dtimepicker">
                        </div>
                    </div>
                ...
                <form class="" action="" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="" type="text" name="reminder_date" placeholder="Reminder Date"
                                   class="form-control dtimepicker">
                        </div>
                    </div>
                    <div class="modal-footer">
