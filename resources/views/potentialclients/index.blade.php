			  ...
			  <div class="toolbar row" style="min-height: 100px;background: #f1f1f1;border: none;opacity:0.8;">
				  ...
				  <div class="col-sm-6 hidden-xs">
					  ...
					  <div class="table-header">
						  <h2 style="font-weight: lighter;margin-top: 35px">{{ $title }}</h2>
					  </div>
               ...
               <tbody>
                  ...
                  ?>
            			<tr>
                            ...
                            <td><small>@if($data->estab_type == 1) Clínica @elseif($data->estab_type == 2)Ponto @else N/d @endif</small></td>
                            <td>{{ $data->estab_users }}</td>
                            <td>@if($data->estab_visit_date == 0000-00-00)N/d @else {{  $data->estab_visit_date->format('d/m/Y') }} @endif</td>
                            ...
                            <td>
                                <div class="btn-group hidden-print">
                                    <button type="button" class="btn btn-sm dropdown-toggle" style="background: #dddddd;opacity: 0.9" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
