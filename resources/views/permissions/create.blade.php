   ...
   <div class="container">
      ...
      <div class="panel panel-white" style="margin-top:8px;">
		  ...
		  <div class="panel-body">
			  ...
			  <!-- start: FORM -->
            <form id="registerPermission" method="POST" action="{{ url('/permissions') }}" autocomplete="off" enctype="multipart/form-data">
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
				   <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
					   ...
					   <input class="form-control" id="description" name="description"  type="text" placeholder="Description" value="param">
				   </div>
   				</div>
