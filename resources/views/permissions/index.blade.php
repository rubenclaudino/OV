               ...
               <tbody>
                  ...
                  ?>
            			<tr>
            				...
            				<td>
                           <div class="btn-group">
                             <button type="button" class="btn btn-squared btn-sm dropdown-toggle" style="background: #dddddd" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                               Options&nbsp;&nbsp;<span class="caret"></span>
                             </button>
                             <ul class="dropdown-menu pull-right">
                               <li><a href="{{ URL::route('permissions.edit', $data->id) }}"><small><i class="fa fa-pencil fa-fw"></i>&nbsp;Edit Permission</small></a></li>
                               <li><a href="#" class="deletePermission" data-id="{{ $data->id }}"><small><i class="fa fa-trash fa-fw"></i>&nbsp;Delete Permission</small></a></li>
                             </ul>
                           </div>
                        </td>
            			</tr>
