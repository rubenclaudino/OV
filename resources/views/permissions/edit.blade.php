            ...
            {{ Form::model($permission, ['route' => ['permissions.update', $permission->id], 'method' => 'PUT','id' => 'updatePermission', 'enctype' => 'multipart/form-data']) }}
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
   					<div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
   					  ...
   					  <input class="form-control" id="name" name="name" type="text" placeholder="Name" value="{{ $permission->name }}">
   					</div>
   				</div>
				<!-- start: SLUG -->
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
               ...
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
   					<div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
   					  ...
   					  <input class="form-control" id="description" name="description"  type="text" placeholder="Description" value="{{ $permission->description }}">
   					</div>
   				</div>
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                     ...
                     <button class="btn btn-success btn-submit btn-squared" data-loading-text="Salvando..." type="submit">Criar Permissão</button>
   					</div>
			   </div>
				<!-- end: BUTTON AREA -->
